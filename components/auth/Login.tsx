...
import googleIconImageSrc from '@/public/images/icons8-google.svg'
import facebookIconImageSrc from '@/public/images/icons8-facebook.svg'
...
const Login = () => {
  const Styles = {
    Container: 'h-screen bg-primary text-white font-medium flex justify-center overflow-hidden',
    Content:
      'max-w-screen-2xl m-0 sm:mx-20 sm:my-16 bg-white text-gray-900 shadow sm:rounded-lg flex justify-center flex-1',
          ...
          <div className={Styles.MainContent}>
            ...
            <div className={Styles.FormContainer}>
              <div className={Styles.SocialButtonsContainer}>
                {socialButtons.map((socialButton, index) => (
                  <a key={index} className={Styles.SocialButton} href={socialButton.url}>
                    {/* <span className={Styles.SocialButtonIconContainer}> */}
              ...
              <p className='mt-6 text-xs text-gray-600 text-center'>
                <Link to='/auth/forgotpassword' className='border-b border-gray-500 border-dotted'>
                  Forgot Password ?
                </Link>
              </p>
