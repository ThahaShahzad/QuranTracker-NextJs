...
const Pricing = () => {
  const { subheading, heading, description, plans, primaryButtonText } = LandingPageDetails.Pricing
  const Styles = {
    ...
    Plan: 'w-full max-w-sm bg-inverse rounded-lg shadow-lg py-10 px-6 sm:px-10 lg:px-6 lg:py-10 xl:p-10 mx-3 flex flex-col justify-between mt-16 first:mt-0 lg:mt-0 shadow-raised',
...
Pricing.getLayout = LandingLayout
