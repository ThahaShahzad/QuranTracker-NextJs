...
import { Button, Heading, useColorMode, Container, Flex, Text } from '@chakra-ui/react'
...
const Components = () => {
  ...
  return (
    <Container maxW='container.xl'>
      ...
      <Flex direction='column' p='4' height='full'>
        <Head>
          <title>Css</title>
        ...
        <div className='flex flex-col gap-4 border-4 w-full p-5'>
          ...
          <Text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, possimus.</Text>
        ...
        <div className='flex flex-col gap-4 border-4 w-full p-5'>
          ...
          <div className='flex justify-start gap-4 p-5'>
            <div className='flex flex-col gap-4 items-center'>
              {[1, 2, 3].map((i) => (
                <Button variant='inverse' key={i} size={i === 1 ? 'sm' : i === 2 ? 'md' : 'lg'}>
                  Primary
                </Button>
              ))}
            </div>
